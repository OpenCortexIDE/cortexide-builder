...
The purpose of this VSCodium fork is to run [Github Actions](https://github.com/cortexide/cortexide-builder/actions). These actions build all the CortexIDE assets (.dmg, .zip, etc), store these binaries on a release in [`cortexide/binaries`](https://github.com/cortexide/binaries/releases), and then set the latest version in a text file on [`cortexide/versions`](https://github.com/cortexide/versions) so CortexIDE knows how to update to the latest version.
