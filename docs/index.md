...
- [Extensions compatibility](https://github.com/cortexide/cortexide/blob/master/docs/extensions-compatibility.md)
- [Migrating from Visual Studio Code to CortexIDE](#migrating)
- [Sign in with GitHub](#signin-github)
- [Accounts authentication](https://github.com/cortexide/cortexide/blob/master/docs/accounts-authentication.md)
- [How do I run CortexIDE in portable mode?](#portable)
- [How do I fix the default file manager?](#file-manager)
- [How do I press and hold a key and have it repeat in CortexIDE?](#press-and-hold)
- [How do I open CortexIDE from the terminal?](#terminal-support)
  - [From Linux .tar.gz](#from-linux-targz)
- [Troubleshooting](https://github.com/cortexide/cortexide/blob/master/docs/troubleshooting.md)
- [Contributing](https://github.com/cortexide/cortexide/blob/master/CONTRIBUTING.md)
- [How to build CortexIDE](https://github.com/cortexide/cortexide/blob/master/docs/howto-build.md)
...
A workaround exists to get debugging working in C# projects, by using Samsung's opensource [netcoredbg](https://github.com/Samsung/netcoredbg) package. See [this comment](https://github.com/cortexide/cortexide/issues/82#issue-409806641) for instructions on how to set that up.
