...
// Root of the repo (same logic as in dependencies.ts)
...
function getNpmProductionDependencies(folder) {
    ...
    try {
        ...
        let match;
        // Filter known benign npm errors but rethrow unexpected ones
        // to preserve original VS Code behavior.
        // These branches mirror the logic in dependencies.ts.
