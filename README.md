...
The purpose of this VSCodium fork is to run [Github Actions](https://github.com//OpenCortexIDE/cortexide/cortexide-builder/actions). These actions build all the CortexIDE assets (.dmg, .zip, etc), store these binaries on a release in [`OpenCortexide/cortex-binaries`](https://github.com/OpenCortexIDE/cortexide-binaries), and then set the latest version in a text file on [`cortexide-versions`](https://github.com/OpencortexIDE/cortexide-versions) so CortexIDE knows how to update to the latest version.
